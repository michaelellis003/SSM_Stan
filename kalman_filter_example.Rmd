...
## Kalman filtering example from Chapter 2.7 of Dynamic Linear Models in with R  

My goal is to test my Kalman filter function I have built in Stan by comparing it to
the function in the dlm R package.  
